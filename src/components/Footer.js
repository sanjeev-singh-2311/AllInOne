...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-black ml-1 mr-1 dark:bg-dark pt-20 pb-10 lg:pt-[120px] lg:pb-20">
      <div className="container mx-auto">
        <div className="flex flex-wrap -mx-4 space-x-20">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="w-full mb-10">
              ...
              <p className="text-base text-body-color dark:text-white mb-7 text-lg font-bold">
                Get all types of services at your doorstep!
              </p>
